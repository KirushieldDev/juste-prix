...
title = Label(frame2, text="Choisir un nombre (1-500)", bg="#2977CA", fg="white", font=("Courrier", 30))
title.pack(pady=10)
...
text = Label(frame2, textvariable=etattxtvar, bg="#2977CA", fg="white", font=("Courrier", 25))
text.pack(pady=10)

chancetxtvar = StringVar()
chancetxtvar.set("Tentatives : 10")

text_chance = Label(frame2, textvariable=chancetxtvar, bg="#2977CA", fg="white", font=("Courrier", 20))
text_chance.pack()

button = Button(frame2, text="Submit", bg="#52B245", fg="white", font=("Courrier", 20), command=essai)
button.pack(pady=30)
